    ...
    <div className="nft-site">
      <header className="nft-header">
        ...
        <nav className={menuOpen ? "nft-nav open" : "nft-nav"} aria-label="Primary navigation">
          ...
          <button className="wallet-button" onClick={() => window.alert("Demo wallet connection — no wallet is connected.")}><Wallet size={16} /> Connect wallet</button>
        </nav>
